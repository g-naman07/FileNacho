...
const SIGNALING_SERVER =
  import.meta.env.VITE_SIGNALING_SERVER_URL || "ws://localhost:5000";
...
const FileTransfer = ({ isSender }) => {
  ...
  const [status, setStatus] = useState(
    "Connecting to signaling server...\nIf the backend is asleep, this can take a moment."
  );
    ...
    const sendNextChunk = () => {
      ...
      while (chunkIndex < chunks.length && channel.bufferedAmount <= HIGH_WATER_MARK) {
        const message = JSON.stringify({
          type: "chunk",
          payload: bufferToBase64(chunks[chunkIndex]),
        });
      ...
      <div style={{ width: "100%", maxWidth: "700px", textAlign: "center" }}>
        ...
        {isSender && file && (
          <div style={{ marginBottom: "20px" }}>
            ...
            <br />
            <p>//Don’t close this tab — your Nacho’s journey is in progress!</p>
          </div>
        )}
